package com.yubin.recognize.uidialog;
...
import com.yubin.recognize.core.recog.MyRecognizer;
import com.yubin.recognize.core.recog.RecogResult;
import com.yubin.recognize.core.recog.listener.ChainRecogListener;
import com.yubin.recognize.core.recog.listener.IRecogListener;
...
public abstract class BaiduASRDialog extends Activity {
    ...
    private static com.yubin.recognize.uidialog.DigitalDialogInput input;


    private static final String TAG = "BaiduASRDialog";

    public static void setInput(com.yubin.recognize.uidialog.DigitalDialogInput input) {
