 ...
 */
package com.yubin.ocrlibrary.ocr.ui.camera;
...
public class Camera1Control implements com.yubin.ocrlibrary.ocr.ui.camera.ICameraControl {
    ...
    private com.yubin.ocrlibrary.ocr.ui.camera.PermissionCallback permissionCallback;
    ...
    @Override
    public void setDisplayOrientation(@com.yubin.ocrlibrary.ocr.ui.camera.CameraView.Orientation int displayOrientation) {
        this.displayOrientation = displayOrientation;
        switch (displayOrientation) {
            case com.yubin.ocrlibrary.ocr.ui.camera.CameraView.ORIENTATION_PORTRAIT:
                rotation = 90;
                break;
            case com.yubin.ocrlibrary.ocr.ui.camera.CameraView.ORIENTATION_HORIZONTAL:
                rotation = 0;
                break;
            case com.yubin.ocrlibrary.ocr.ui.camera.CameraView.ORIENTATION_INVERT:
                rotation = 180;
                break;
            default:
                rotation = 0;
    ...
    @Override
    public void setPermissionCallback(com.yubin.ocrlibrary.ocr.ui.camera.PermissionCallback callback) {
    ...
    private void updateFlashMode(int flashMode) {
        switch (flashMode) {
            ...
            case FLASH_MODE_OFF:
                ...
                break;
            case com.yubin.ocrlibrary.ocr.ui.camera.ICameraControl.FLASH_MODE_AUTO:
    ...
    private int getSurfaceOrientation() {
        @com.yubin.ocrlibrary.ocr.ui.camera.CameraView.Orientation
