...
import com.yubin.ocrlibrary.ocr.ui.util.DimensionUtil;
import com.yubin.ocrlibrary.ocr.ui.util.ImageUtil;
...
public class CameraView extends FrameLayout {
     ...
     * 身份证，银行卡，等裁剪用的遮罩
     */
    private com.yubin.ocrlibrary.ocr.ui.camera.MaskView maskView;
    ...
    public void setMaskType(@MaskView.MaskType int maskType, final Context ctx) {
        ...
        switch (maskType) {
            case com.yubin.ocrlibrary.ocr.ui.camera.MaskView.MASK_TYPE_ID_CARD_FRONT:
                hintResourceId = R.drawable.bd_ocr_round_corner;
                isNeedSetImage = false;
                break;
            case com.yubin.ocrlibrary.ocr.ui.camera.MaskView.MASK_TYPE_ID_CARD_BACK:
                isNeedSetImage = false;
                hintResourceId = R.drawable.bd_ocr_round_corner;
                break;
            case com.yubin.ocrlibrary.ocr.ui.camera.MaskView.MASK_TYPE_BANK_CARD:
                hintResourceId = R.drawable.bd_ocr_hint_align_bank_card;
                break;
            case com.yubin.ocrlibrary.ocr.ui.camera.MaskView.MASK_TYPE_PASSPORT:
                hintView.setVisibility(INVISIBLE);
                break;
            case com.yubin.ocrlibrary.ocr.ui.camera.MaskView.MASK_TYPE_NONE:
            default:
...
//        }
        ...
        maskView = new com.yubin.ocrlibrary.ocr.ui.camera.MaskView(getContext());
        addView(maskView);
