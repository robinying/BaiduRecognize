...
public interface ICameraControl {
     ...
     * @param callback 权限回调
     */
    void setPermissionCallback(com.yubin.ocrlibrary.ocr.ui.camera.PermissionCallback callback);

    /**
     * 设置水平方向
     * @param displayOrientation 参数值见 {@link com.yubin.ocrlibrary.ocr.ui.camera.CameraView.Orientation}
     */
    void setDisplayOrientation(@com.yubin.ocrlibrary.ocr.ui.camera.CameraView.Orientation int displayOrientation);
